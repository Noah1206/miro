...
const ITEMS = [
  ...
  /**
   * 미로 — Reality 인터랙션을 가진, 중심이 되는 캐릭터들이 모인 곳. 들어가는 문이다.
   * 뜻은 라벨이 맡고 아이콘은 자리만 지킨다 — 나침반(탐색)도, 별(장식)도 아니다.
   *
   * 바로 옆 '만들기' 도 같은 크기의 채운 원이라, 가운데를 크게 뚫어(속 r=5.0, 만들기의 플러스는
   * 폭 2) 고리와 원반으로 갈리게 했다. 굵기가 얇으면 로딩 표시처럼 보이므로 살을 남긴다.
   */
  { href: '/miro', label: '미로',
    icon: <path d="M12 2.6a9.4 9.4 0 1 0 0 18.8 9.4 9.4 0 0 0 0-18.8zm0 4.4a5 5 0 1 1 0 10 5 5 0 0 1 0-10z" /> },

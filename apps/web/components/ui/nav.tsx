...
const ITEMS = [
  ...
  /**
   * 미로 — Reality 인터랙션을 가진, 중심이 되는 캐릭터들이 모인 곳. 나침반(탐색)이 아니라
   * '여기가 특별한 자리' 라고 말하는 반짝임이다. 큰 별 하나에 작은 별 둘이 대각으로 따라붙는다.
   *
   * 별은 원래 집·원·말풍선보다 잉크가 적어 혼자 앙상해 보인다. 옆구리를 덜 파서(제어점 0.38R)
   * 살을 남기고, 작은 별 둘로 잉크를 보태고, 뾰족한 모양은 눈에 작아 보이므로 다른 아이콘보다
   * 한 단 크게(폭 21.4 vs 18.8) 그린다 — 셋을 합쳐 나머지 평균 잉크의 81% 까지 온다.
   */
  { href: '/miro', label: '미로',
    icon: <path d="M11.2 2.2Q15 8.4 21.2 12.2Q15 16 11.2 22.2Q7.4 16 1.2 12.2Q7.4 8.4 11.2 2.2ZM19.2 1.8Q20.49 3.91 22.6 5.2Q20.49 6.49 19.2 8.6Q17.91 6.49 15.8 5.2Q17.91 3.91 19.2 1.8ZM4.6 16.9Q5.55 18.45 7.1 19.4Q5.55 20.35 4.6 21.9Q3.65 20.35 2.1 19.4Q3.65 18.45 4.6 16.9Z" /> },

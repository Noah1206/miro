  ...
  return (
    <div style={{ padding: '0 var(--space-4) 8px', maxWidth: 560, width: '100%', margin: '0 auto' }}>
      ...
      <form ref={ref} action={action} style={{ display: 'flex', gap: 8 }}>
        ...
        <Pressable type="submit" disabled={pending} aria-label="말하기" style={{ width: 46, height: 46, borderRadius: 999, border: '1px solid var(--color-border-strong)', background: 'var(--color-surface-3)', color: 'var(--color-text-primary)', display: 'grid', placeItems: 'center', flexShrink: 0 }}>

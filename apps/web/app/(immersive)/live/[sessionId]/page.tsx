    ...
    <LiveStage sessionId={sessionId} characterName={loaded.characterName} background={background}
      header={
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
          <TransitionLink href={`/chat/${sessionId}`} direction="back" className="t-caption" style={{ padding: '7px 10px', borderRadius: 'var(--radius-sm)', background: 'rgba(10,10,11,0.6)' }}>‹ 대화로</TransitionLink>

          ...
          <Section title="성향" subtitle="같은 말에도 캐릭터마다 다르게 반응하게 하는 값입니다.">
            <Card>
              <div className="stack" style={{ gap: 20 }}>
                <Slider name="jealousy" label="질투" defaultValue={50} lo="무던함" hi="예민함" />
                <Slider name="initiative" label="주도성" defaultValue={50} lo="기다림" hi="먼저 다가감" />
                <Slider name="emotionalExpression" label="감정 표현" defaultValue={50} lo="숨김" hi="드러냄" />
              </div>
            </Card>
          </Section>
        </Panel>
          ...
          <Section title="시작 관계" subtitle="처음 만났을 때 두 사람이 서 있는 자리. 대화하면서 바뀝니다.">
            <Card>
              ...
              <div className="stack" style={{ gap: 20, marginTop: 'var(--space-5)' }}>
                <Slider name="trust" label="신뢰" defaultValue={30} lo="의심" hi="믿음" />
                <Slider name="attraction" label="호감" defaultValue={10} lo="무관심" hi="끌림" />
                <Slider name="emotionalDistance" label="정서적 거리" defaultValue={60} lo="가까움" hi="멂" />
                <Slider name="attachment" label="애착" defaultValue={10} lo="없음" hi="강함" />
                <Slider name="protectiveness" label="보호 성향" defaultValue={20} lo="방관" hi="개입" />
                <Slider name="relJealousy" label="질투 (관계)" defaultValue={0} lo="없음" hi="강함" />
              </div>
            </Card>
          </Section>
          ...
          {contactOn && (
            <>
              <Section title="얼마나">
                <Card>
                  <div className="stack" style={{ gap: 20 }}>
                    <Slider name="contactFrequency" label="연락 빈도" defaultValue={50} lo="드물게" hi="자주" />
                    <Slider name="initiativeLevel" label="주도성" defaultValue={50} lo="기다림" hi="먼저" />
              ...
              <Section title="어떻게">
                <Card>
                  ...
                  <div className="stack" style={{ gap: 20, marginTop: 'var(--space-5)' }}>
                    <Slider name="photoProbability" label="사진" defaultValue={20} lo="거의 안 함" hi="자주" />
                    <Slider name="voiceMessageProbability" label="음성 메시지" defaultValue={20} lo="거의 안 함" hi="자주" />
                    <Slider name="callProbability" label="전화" defaultValue={30} lo="거의 안 함" hi="자주" />
                    <Slider name="videoCallProbability" label="영상통화" defaultValue={10} lo="거의 안 함" hi="자주" />
                  </div>
                </Card>
              </Section>

...
const STEPS: Array<{ tab: CreateTab; lines: string[] }> = [
  { tab: 'profile', lines: ['이름과 소개만 있으면 시작할 수 있어요.', '사진은 나중에 넣어도 돼요.'] },
  { tab: 'personality', lines: ['어떤 사람인지 한 칸에 적어요.', '특징, 가치관, 말투를 섞어도 돼요.'] },
  { tab: 'appearance', lines: ['성별과 체형만 고르면 사진이 나와요.', '얼굴과 머리는 고급 설정에서.'] },
  { tab: 'relationship', lines: ['처음 만났을 때 두 사람의 거리예요.', '대화하면서 조금씩 바뀝니다.'] },
  { tab: 'contact', lines: ['앱을 닫아도 먼저 연락할지 정해요.', '얼마나 자주 올지도요.'] },
  { tab: 'intro', lines: ['첫 장면을 적으면 등록할 수 있어요.', '소개 페이지 탭에서 미리 보세요.'] },
]

...
export const COPY = {
  error: {
    ...
    budgetMonthly: '이번 달 이어갈 수 있는 대화를 모두 썼어요. 다음 달에 다시 이어갈 수 있고, 기존 대화와 기억은 그대로 남아요.',
  },
  /** 이용권 — 자동 갱신이 없으므로 끝나기 전에 알린다. 사용량 소진은 알리지 않는다. */
  pass: {
    soonPush: {
      title: 'MIRO 이용권이 곧 끝나요',
      body: '3일 뒤 Pro 이용권이 끝나요. 이어서 쓰려면 다시 받을 수 있어요.',
    },
    endedPush: {
      title: 'MIRO 이용권이 끝났어요',
      body: '대화와 기억은 그대로 남아 있어요. 이어서 쓰려면 이용권을 다시 받아 주세요.',
    },
  },
  /** 환불 조건은 구매 전에 보여 준다 — 숨기지 않는다는 것이 확정된 방침이다. */
  refund: {
    recharge: '충전 후 7일 안에는 아직 쓰지 않은 사용량을 전액 환불해 드려요. 일부를 썼다면 남은 만큼 환불돼요.',
    pass: '이용권은 받은 뒤 7일 안에 환불할 수 있어요. 쓴 날만큼은 일할 계산으로 빼고 돌려드려요.',
    failure: '서비스 장애나 잘못 지급된 경우에는 기간과 상관없이 전액 환불해 드려요.',
    how: '환불은 설정에서 문의해 주시면 입금하신 계좌로 보내 드려요.',
  },
  status: {

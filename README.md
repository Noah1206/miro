...
요금제 방향은 [Miro Free / Pro 요금 정책](docs/MIRO_PRICING_POLICY.md)을 따른다. Free에서도 Reality Interaction을 경험하고, Pro는 하나의 월간 풀로 경험의 깊이와 빈도를 넓힌다. 별도 코인 충전팩이나 모델별 턴 상품은 두지 않는다.

...
- 2026-09-14: Closed Alpha(/alpha) 구현 — 로그인 없이 유진 1명과 대화, 규칙 기반 관계 엔진, 리얼리티 메시지·클리프행어·웨이트리스트. AI 는 AI_PROVIDER(gemini/cloudflare/mock) 로 /api/chat 에서만. 하루 한도(사용자 15·전체 300·IP 분당 8)
